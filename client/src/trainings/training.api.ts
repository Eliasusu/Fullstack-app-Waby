...
export const updateTrainingReq = (training: Training) => axios.put(`/trainings/${training.idTraining}/user`, training);

export const deleteTrainingReq = (id: number) => axios.delete(`/trainings/${id}/user`);