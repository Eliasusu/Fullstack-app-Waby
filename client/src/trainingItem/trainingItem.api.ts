...
import { TrainingItem, TrainingItemProps } from "@/trainingItem/trainingItems.type.ts";
...
export const updateTrainingItemReq = (trainingItem: TrainingItem, idTraining: string, idTItem: string ) => axios.put(`/trainings/${idTraining}/trainingItem/${idTItem}`, trainingItem);
